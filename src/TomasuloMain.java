...
public class TomasuloMain {
    ...
    public static void main(String[] args){
        ...
        reader.readFile();
        TomasuloMemory memory = TomasuloMemory.createInstance();
        ...
        for(String[] line : reader.linesoup){
            ...
            for (int i=0; i < line[1].length() / 2; i++ ) {
                ...
                memoryDataEntry = b;
                memory.addLineOfData(memoryAddressPointer+i,memoryDataEntry);
                System.out.println("memory data: " + memoryDataEntry);
            }
            System.out.println("memoryDataEntry " + memoryDataEntry);
            //memory.addLineOfData(memoryAddressPointer,memoryDataEntry);
            System.out.println("============================================");
        }
        System.out.println("============================================");
        memory.printDataContents();
        //TomasuloCentralProcessingUnit cpu = new TomasuloCentralProcessingUnit();
    }
